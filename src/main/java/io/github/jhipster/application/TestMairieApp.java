...
public class TestMairieApp {

    private static final Logger log = LoggerFactory.getLogger(TestMairieApp.class);

    private final Environment env;

    public TestMairieApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes testMairie.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TestMairieApp.class);
